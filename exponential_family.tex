...
\newcommand{\sufficientStatsFunction}{t}
...
\newcommand{\sufficientStatsFunctionForSingleSample}{\wt{t}}
...
Let $X$ have an exponential family distribution with natural parameter $\eta$, sufficient statistics function $t$, and log normalizer function $\logNormalizerFunction$.   Then  
\begin{align*}
