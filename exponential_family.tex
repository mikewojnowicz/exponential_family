...
&= \E_{\param^^t}[\sufficientStatsFunction(\+X,\+Z) \cond \+X=\+x] - 	\meanParam^^t && \scripttext{Def. mean parameter} \\
&=\E_{\param^^{t+1}}[\sufficientStatsFunction(\+X,\+Z)] - 	\meanParam^^t && \scripttext{Prop.~\ref{prop:interesting_representation_of_EM_update_to_params} (EM step)} \\
