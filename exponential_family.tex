...
\red{TODO:  State what a conjugate prior is without using the formalism of Section \ref{sec:ef_general_formalism}} 
 ...
 \subsection{Example:  Normal prior on mean of multivariate Gaussian with known covariance}
 
\red{TODO.   Note that in Section \ref{{sec:Bayesian_linear_regression_with_normal_prior}
},   I've already written up a self-enclosed argument for Bayesian linear regression;  some of that argument can likely be factored out to here.}
...
\subsection{Example:  Bayesian linear regression with normal prior on regression weights} \label{sec:Bayesian_linear_regression_with_normal_prior}
