...
\begin{example}\exampletitle{Bernoulli Distribution.}
...
\begin{example}\exampletitle{Categorical Distribution.}
...
\begin{example}\exampletitle{Dirichlet Distribution.} 
...
\begin{example}\exampletitle{Truncated normal distribution.}
...
\begin{example}\exampletitle{Inverse Gamma Distribution.} 
...
\begin{example}\exampletitle{Multivariate normal.}
...
\begin{example}\exampletitle{Inverse Wishart distribution.}
...
\begin{example}\exampletitle{Hidden Markov Models.}
...
\begin{example}\exampletitle{Inverse Wishart prior on the covariance of a  Multivariate Normal sampling model with known mean}
